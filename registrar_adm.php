                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Crie uma Conta Administrador</h3></div>
                                    <div class="card-body">
                                        <form action="funcoes/cadastrar_adm.php" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="telefone" class="form-control py-4" id="telefone" type="text" placeholder="Escreva seu Telefone" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);">
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="situacao">Situação</label>
