                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Crie uma Conta de Funcionário</h3></div>
                                    <div class="card-body">
                                        <form action="funcoes/cadastrar_funcionarios.php" method="post">
                                            <div class="form-row">
                                                <div class="col-md-6">
